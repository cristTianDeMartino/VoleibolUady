...
const mockVideos: VideoCard[] = [
  ...
  { id: 6, titulo: '¡Somos UADY! — Video Motivacional', descripcion: 'Compilación de momentos destacados de la temporada con música motivacional.', tipo: 'Motivacional', duracion: '05:48', fecha: '2026-05-25', thumbnail: '🏆' },
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <button
          disabled
          className="bg-uady-orange-cta text-white px-4 py-2 rounded-lg text-sm font-semibold opacity-50 cursor-not-allowed self-start md:self-auto"
        >
          + Subir Video
        </button>
      </div>
