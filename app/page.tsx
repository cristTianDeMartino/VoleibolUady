        ...
        <div className="absolute inset-0 bg-gradient-to-r from-uady-blue via-uady-blue/80 to-transparent flex items-center">
          <div className="max-w-5xl mx-auto px-4 py-16">
            ...
            <h1 className="text-4xl md:text-5xl font-black leading-tight mb-4">
              ...
              <span className="block text-uady-gold">Club de Voleibol</span>
            </h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1">
              ...
              <div className="mt-6">
                <Link
                  href="/plan-rector"
                  className="inline-flex items-center gap-2 bg-uady-gold hover:brightness-110 transition-all duration-200 text-uady-blue font-bold text-sm px-5 py-3 rounded-lg shadow-md shadow-black/20"
                >
