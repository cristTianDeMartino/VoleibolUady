...
export const metadata = { title: 'Roster de Atletas — UADY Voleibol' }
        ...
        <div className="flex gap-2 items-center">
          {isAdmin && (
            <Link
              ...
              className="bg-uady-orange-cta text-white px-5 py-2 rounded-lg text-sm font-bold hover:brightness-110 transition-all duration-200 flex items-center gap-1.5"
            >
              + Agregar Atleta
            </Link>
          )}
      ...
      {atletas.length === 0 && (
        <div className="text-center py-24 bg-white rounded-2xl border border-gray-100">
          ...
          {isAdmin && (
            <Link
              href="/atletas/agregar"
              className="inline-block bg-uady-orange-cta text-white px-6 py-2.5 rounded-lg font-bold text-sm hover:brightness-110 transition-all"
            >
