    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="text-3xl font-black text-uady-blue">Programa Físico</h1>
        </div>
