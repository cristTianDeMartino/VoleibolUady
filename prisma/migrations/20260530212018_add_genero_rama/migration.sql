...
INSERT INTO "new_Atleta" ("apellidos", "codigoAcceso", "createdAt", "directorFacultad", "facultad", "fotoUrl", "genero", "id", "nombre", "nss", "posicion", "rol", "seguroPrivado", "semestre", "telefonoPersonal", "telefonoTutor") SELECT "apellidos", "codigoAcceso", "createdAt", "directorFacultad", "facultad", "fotoUrl", "genero", "id", "nombre", "nss", "posicion", "rol", "seguroPrivado", "semestre", "telefonoPersonal", "telefonoTutor" FROM "Atleta";
DROP TABLE "Atleta";
